...
{
    /// <summary>
    /// Summary description for DressHandler
    /// </summary>
    public class DressHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select Image from Dress where DressID =" + context.Request.QueryString["Img"] + "", con);
