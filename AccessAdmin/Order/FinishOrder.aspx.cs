...
{
    public partial class AddStyleForDress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Dressandmeasurements.aspx");
            }
        ...
        protected void SubmtButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ErrorDateLabel.Text = "তারিখ দিন";
                }

            }
            catch (SqlException ex)
            {
                ErrorDateLabel.Text = ex.Message;
            }
        }
