<%@ Page Title="সাব-অ্যাডমিন রেজিস্ট্রেশন" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="SignUp_Sub_Admin.aspx.cs" Inherits="TailorBD.AccessAdmin.Sub_Admin.SignUp_Sub_Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   <h3>নতুন সাব-অ্যাডমিন এর জন্য রেজিস্ট্রেশন</h3>
   <div class="SubAdmin">
         ...
         <WizardSteps>
            <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
               <ContentTemplate>
                  <table>
                     <tr>
                        <td align="right" class="LabelText">সাব-অ্যাডমিন এর নাম</td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">লগইন ইউজার নাম
                        </td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">লগইন পাসওয়ার্ড
                        </td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">পাসওয়ার্ড নিশ্চিত করুন
                        </td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">ই-মেইল
                        </td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">নিরাপত্তা প্রশ্ন
                        </td>
                        <td>
                     ...
                     <tr>
                        <td align="right" class="LabelText">নিরাপত্তা উত্তর
                        </td>
                        <td>
