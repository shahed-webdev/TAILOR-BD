<%@ Page Title="" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Print_Invoice.aspx.cs" Inherits="TailorBD.AccessAdmin.Invoice.Print_Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   ...
   <br />
   <input id="btnPrint" type="button" value="Print" onclick="window.print();" class="ContinueButton"/>
</asp:Content>
